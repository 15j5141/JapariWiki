...
/* harmony import */ var _class_page_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./class-page.js */ "./src/scripts/class-page.js");
...
var JWStatus = /*#__PURE__*/function () {
  ...
  _createClass(JWStatus, [{
    ...
    value: function load() {
      ...
      var session = _objectSpread({}, this.statusDefault, {}, JSON.parse(json));
      /** URL のクエリ確認用 */
    ...
    value: function resolveURI(pageURI) {
      if (_class_page_js__WEBPACK_IMPORTED_MODULE_15__["default"].isAbsoluteURI(pageURI)) {
        // 絶対パスならそのまま.
        return pageURI;
      } else {
